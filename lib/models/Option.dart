...
class Option extends Model {
  ...
  const Option._internal({required this.id, name, menuitems, price, menuType, sortOrder, createdAt, updatedAt}): _name = name, _menuitems = menuitems, _price = price, _menuType = menuType, _sortOrder = sortOrder, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Option({String? id, String? name, List<MenuItemOption>? menuitems, String? price, MenuType? menuType, int? sortOrder}) {
  ...
  Option copyWith({String? id, String? name, List<MenuItemOption>? menuitems, String? price, MenuType? menuType, int? sortOrder}) {
    return Option._internal(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'menuitems': _menuitems?.map((MenuItemOption? e) => e?.toJson()).toList(), 'price': _price, 'menuType': enumToString(_menuType), 'sortOrder': _sortOrder, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
