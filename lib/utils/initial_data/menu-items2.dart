...
List<MenuItemModel> initialMenuModelArray = [
  ...
  const MenuItemModel(14, '', MenuType.SANDWICH, '', '', '2.25'),
  const MenuItemModel(15, 'Cappuccino', MenuType.BEVERAGE, '', '', '4.25'),
  const MenuItemModel(16, 'Latte', MenuType.BEVERAGE, '', '', '4.25'),
  const MenuItemModel(17, 'Espresso', MenuType.BEVERAGE, '', '', '2.99'),
  const MenuItemModel(18, 'Espresso Macchiato', MenuType.BEVERAGE, '', '', '3.50'),
  const MenuItemModel(19, 'Double Espresso', MenuType.BEVERAGE, '', '', '4.25'),
  const MenuItemModel(20, 'Double Macchiato', MenuType.BEVERAGE, '', '', '4.25'),
  const MenuItemModel(21, 'Double Cappuccino', MenuType.BEVERAGE, '', '', '4.59'),
  const MenuItemModel(22, 'Hot/Iced Tea', MenuType.BEVERAGE, '', '', '2.99'),
  const MenuItemModel(23, 'Hot Chocolate', MenuType.BEVERAGE, '', '', '3.29'),
  const MenuItemModel(24, 'Americano', MenuType.BEVERAGE, 'Americano', '', '2.99'),
  const MenuItemModel(25, 'All Above Can Be Iced', MenuType.BEVERAGE, '', '', ''),
  const MenuItemModel(26, 'Add a Flavor', MenuType.BEVERAGE, '', '', '0.99'),
  const MenuItemModel(27, 'Almond, Soy, or Coconut Milk', MenuType.BEVERAGE, '', '', '0.99'),
  const MenuItemModel(
