...
List<MenuItemModel> initialMenuModelArray = [
  ...
  const MenuItemModel(28, 'Sandwich', MenuType.BREAKFAST,
      'Egg, Ham, Provolone on Toasted Roll or Croissant', '', '9.99'),
  ...
  const MenuItemModel(
      32, 'Ham and Cheese', MenuType.BREAKFAST, '3 Eggs with Ham & Provolone', '', '9.99'),
  const MenuItemModel(33, 'Cheese', MenuType.BREAKFAST, '3 Eggs with Provolone', '', '9.99'),
  const MenuItemModel(
      34, 'Egg White Omelet', MenuType.BREAKFAST, 'Arugula, Tomato & Mozzarella', '', '9.99'),
  const MenuItemModel(
  ...
  const MenuItemModel(39, 'A La Salizz', MenuType.PIZZA,
      'Italian Sausage, Mozzarella, Tomato Sauce', '16.99', '22.99'),
  ...
  const MenuItemModel(
      ...
      'Altamura',
      MenuType.PIZZA,
      'Bresaola, Arugula, Mozzarella Cheese, Shaved Parigiano Cheese, Cherry Tomato',
      '16.99',
      '23.99'),
  const MenuItemModel(
      44,
  ...
  const MenuItemModel(
      54, '', MenuType.PASTRY, 'Sfogliatella (Ricotta & Citrus Fruit)', '3.25', '4.00'),
  const MenuItemModel(55, '', MenuType.PASTRY, 'Lobster Tail with Custard & Cream', '', '4.00'),
  const MenuItemModel(
      56, '', MenuType.PASTRY, 'Cannoli with Ricotta & Chocolate Chip', '3.25', '4.00'),
